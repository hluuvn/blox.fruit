...
Main1=Window:AddTab({ Title="Cày khác" }),
    ...
    Fruit=Window:AddTab({ Title="Trái Fruit" }),
...
Tabs.Info:AddParagraph({
    Title="Cập nhập and Thông báo",
    Content="Script hỗ trợ pc và pe"
})
Tabs.Info:AddParagraph({
    Title="Hỗ trợ tất cả Clients Android",
    Content=""
})
Tabs.Info:AddParagraph({
    Title="Hỗ trợ tất cả Clients PC",
    Content=""
})
...
local AutoFram = Tabs.Main1:AddSection("Cày khác")
    local ToggleCastleRaid = Tabs.Main1:AddToggle("ToggleCastleRaid", {
        Title="Tự động đánh hải tặc trên biển",
        Description="", 
        Default=false })
...
local ToggleHakiFortress = Tabs.Main1:AddToggle("ToggleHakiFortress", { 
    Title="Tự đongo mua Haki/Bật Haki", 
    Description="", 
    Default=false 
})
...
local ToggleCollectBerry = Tabs.Main1:AddToggle("ToggleCollectBerry", {
    Title = "Tự động nhặt Berry và đổi server",
    Description = "",
    Default = false
})
...
if Sea3 then
local MiscFarm = Tabs.Main:AddSection("Cày xương lâu đài")
...
spawn(function()
    pcall(function()
        while wait() do
            ...
            StatusBone:SetDesc("Bạn có: " .. tostring(bones) .. " Xương")
        end
    end)
end)
...
spawn(function()
  while wait() do
    ...
    if Sea2 then
    local MiscFarm = Tabs.Main:AddSection("Cày Vật chất kì dị")
    local ToggleVatChatKiDi = Tabs.Main:AddToggle("ToggleVatChatKiDi", {
        Title="Tự động fram vật chất kì dị",
        Description="", 
        Default=false })
...
if Sea3 then
local RoughSea = Tabs.Sea:AddSection("Đảo Kitsune")
...
local Usser = Tabs.Info:AddParagraph({
    ...
    Content="\n"..
        ...
        "Tiền/Beli : "..game:GetService("Players").LocalPlayer.Data.Beli.Value.."\n"..
...
local ServerTime = Tabs.Status:AddParagraph({
    Title="Thời gian chơi trong server",
    Content=""
})
...
local Input = Tabs.Status:AddInput("Input", {
    ...
    local Toggle = Tabs.Status:AddToggle("MyToggle", {Title="Tham gia server rác", Default=false })
...
local ToggleAwake = Tabs.Raid:AddToggle("ToggleAwake", {Title="Tự thức tỉnh",Description="", Default=false })
...
Tabs.Race:AddButton({
    Title="Bay đến ngôi đền thời gian",
    Description="",
    Callback=function()
...
local ToggleHumanandghoul = Tabs.Race:AddToggle("ToggleHumanandghoul", {Title="Tự động qua màn Human/Ghoul",Description="", Default=false })
...
local ToggleKillTrial = Tabs.Race:AddToggle("ToggleKillTrial", {Title="Đánh người chơi", Description="", Default=false})
...
local Mastery = Tabs.Race:AddSection("Thức tỉnh tộc")
local ToggleFarmRace = Tabs.Race:AddToggle("ToggleFarmRace", {Title="Tự động bật v4 tích nộ", Description="", Default=false})
